...
// #define ESP32_1216S035
//   #define ESP32_2432S089
...
#define TFT_BL 32
Arduino_DataBus *bus = new Arduino_ESP32SPI(27 /* DC */, 14 /* CS */, 18 /* SCK */, 23 /* MOSI */, GFX_NOT_DEFINED /* MISO */);
Arduino_GFX *gfx = new Arduino_ILI9341(  bus, 33 /* RST */, 0 /* rotation */);


#elif defined(ESP32_1216S035)
#define TFT_BL 22
...
#elif defined(ESP32_2432S089)
#define TFT_BL 22
Arduino_DataBus *bus = new Arduino_ESP32SPI(27 /* DC */, 5 /* CS */, 18 /* SCK */, 23 /* MOSI */, GFX_NOT_DEFINED /* MISO */, VSPI /* spi_num */);
Arduino_GFX *gfx = new Arduino_ST7789(  bus, 33 /* RST */, 0 /* rotation */);
